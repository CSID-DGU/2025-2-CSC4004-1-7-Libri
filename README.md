...
```
신호 강도 = 투표 합산 / 4
매수 비율 = 신호 강도 × 0.5 (최대 50%)
매수 금액 = 보유 현금 × 매수 비율

예시:
- 3표 매수 (3/4): 현금의 37.5% 매수
- 4표 매수 (4/4): 현금의 50% 매수 (만장일치)
```

**매도 수량 (투표 합산 ≤ -3):**
```
신호 강도 = |투표 합산| / 4
매도 비율 = 신호 강도 × 0.5 (최대 50%)
매도 주식 수 = 보유 주식 × 매도 비율

예시:
- 3표 매도 (3/4): 보유 주식의 37.5% 매도
- 4표 매도 (4/4): 보유 주식의 50% 매도 (만장일치)
```

**투표 예시:**
```
상황 1: Buy 4표, Hold 0표, Sell 0표 → 합산 +4 → 현금의 50% 매수
상황 2: Buy 3표, Hold 1표, Sell 0표 → 합산 +3 → 현금의 37.5% 매수
상황 3: Buy 2표, Hold 2표, Sell 0표 → 합산 +2 → 관망 (거래 없음)
상황 4: Buy 2표, Hold 0표, Sell 2표 → 합산 0 → 관망 (거래 없음)
상황 5: Buy 0표, Hold 1표, Sell 3표 → 합산 -3 → 보유 주식의 37.5% 매도
```
