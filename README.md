...
AI가 '적극 매수'을 결정한 주된 이유는 다음과 같습니다.
  ...
  1. 'RSI' 지표의 최근 움직임을 가장 중요하게 고려했습니다.
  2. 'MACD' 지표가 2순위로 결정에 영향을 미쳤습니다.
  3. 'AnalystRating' 지표를 참고했습니다.
...
--- 4. (참고) 상세 Q_total 그리드 ---
    ...
    ------------------------------------------------------
     Long      |   152.7314 |   110.1234 |   -30.6789 |
     Hold      |    95.9876 |    60.4321 |   -50.1234 |
     Short     |   -70.1111 |  -100.2222 |  -180.3333 |
=============================================
```
**출력 해석**
