...
```
신호 강도 = 투표 합산 / 4
매수 비율 = 신호 강도 × 0.3 (최대 30%)
매수 금액 = 보유 현금 × 매수 비율

예시:
- 2표 매수 (2/4): 현금의 15% 매수
- 3표 매수 (3/4): 현금의 22.5% 매수
- 4표 매수 (4/4): 현금의 30% 매수 (만장일치)
```
...
**투표 예시:**
```
상황 1: Buy 4표, Hold 0표, Sell 0표 → 합산 +4 → 현금의 30% 매수
상황 2: Buy 3표, Hold 1표, Sell 0표 → 합산 +3 → 현금의 22.5% 매수
상황 3: Buy 2표, Hold 2표, Sell 0표 → 합산 +2 → 현금의 15% 매수
