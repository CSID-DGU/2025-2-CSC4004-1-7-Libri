...
**2-2. 매수, 매도 수량 (신호 강도 기반)**

AI는 4개 에이전트의 투표를 통해 매수/매도/관망을 결정합니다.

**투표 시스템:**
- 각 에이전트는 Buy(+1), Hold(0), Sell(-1) 중 하나를 선택
- 투표 합산: -4 ~ +4 범위
...
매수 금액 = 총 자산(포트폴리오 가치) × 매수 비율

예시:
- 2표 매수 (2/4): 총 자산의 5% 매수
- 3표 매수 (3/4): 총 자산의 7.5% 매수
- 4표 매수 (4/4): 총 자산의 10% 매수 (만장일치)
```
...
예시:
- 2표 매도 (2/4): 보유 주식의 15% 매도
- 3표 매도 (3/4): 보유 주식의 22.5% 매도
- 4표 매도 (4/4): 보유 주식의 30% 매도 (만장일치)
```

**투표 예시:**
```
상황 1: Buy 4표, Hold 0표, Sell 0표 → 합산 +4 → 총 자산의 10% 매수
상황 2: Buy 3표, Hold 1표, Sell 0표 → 합산 +3 → 총 자산의 7.5% 매수
상황 3: Buy 2표, Hold 2표, Sell 0표 → 합산 +2 → 총 자산의 5% 매수
상황 4: Buy 2표, Hold 0표, Sell 2표 → 합산 0 → 관망 (거래 없음)
상황 5: Buy 1표, Hold 2표, Sell 1표 → 합산 0 → 관망 (거래 없음)
상황 6: Buy 0표, Hold 2표, Sell 2표 → 합산 -2 → 보유 주식의 15% 매도
```

**장점:**
- 3표 이상 합의 시에만 거래하여 신중한 의사결정
- 의견이 엇갈릴 때는 관망하여 리스크 관리
- 신호 강도에 비례한 거래량으로 확신도 반영
