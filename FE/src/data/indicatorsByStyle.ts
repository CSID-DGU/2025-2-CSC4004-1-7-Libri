...
export const aggressiveIndicators: IndicatorInfo[] = [
    ...
    },
    {
        ...
        shortDescription:
            "볼린저 밴드가 수축하며 변동성이 낮은 구간에 진입했습니다. 추후 급등락 가능성에 유의해야 합니다.",
        detailedDescription:
            "BB_BW(Bollinger Band Width)는 볼린저 밴드의 폭을 나타내는 지표입니다. 폭이 좁을수록 변동성이 낮고, 곧 큰 변동이 올 가능성이 있습니다.",
        interpretationPoints: [
            "폭이 좁아지면 큰 변동 전 신호",
            "폭이 넓어지면 변동성 확대 진행 중",
...
export const conservativeIndicators: IndicatorInfo[] = [
    {
        ...
        detailedDescription:
            "부채비율이 업종 평균보다 낮아 재무 건전성이 양호합니다. 안정적인 재무구조를 바탕으로 장기 투자에 적합합니다.",
        interpretationPoints: [
            "부채비율 100% 이하면 건전",
            "부채비율 상승은 재무 위험 증가",
            "업종 특성 고려한 분석 필요",
    ...
    },
    {
        ...
        detailedDescription:
            "자기자본이익률(ROE)이 15%로 양호한 수준을 유지하고 있습니다. 주주 가치 창출 능력이 우수합니다.",
        interpretationPoints: [
            "ROE 10% 이상이면 우수",
            "ROE 상승은 수익성 개선",
            "지속 가능한 ROE가 중요",
    ...
    },
    {
        ...
        detailedDescription:
            "PER(주가수익비율)이 12배로 업종 평균 대비 적정 수준입니다. 저평가도 고평가도 아닌 안정적인 구간입니다.",
        interpretationPoints: [
            "PER 낮을수록 저평가 가능성",
            "업종 평균 PER과 비교 필요",
            "성장성 고려한 PER 분석 필요",
    ...
    },
    {
        ...
        detailedDescription:
            "PBR(주가순자산비율)이 1.2배로 저평가 구간에 있습니다. 장부가치 대비 매력적인 가격대입니다.",
        interpretationPoints: [
            "PBR 1배 이하면 저평가",
    ...
    },
    {
        ...
        detailedDescription:
            "배당수익률이 3.5%로 시장 금리 대비 매력적입니다. 안정적인 배당 수익이 기대됩니다.",
        interpretationPoints: [
            "배당수익률 3% 이상이면 양호",
            "배당 지속성 확인 필요",
            "배당성향과 함께 분석",
    ...
    },
    {
        ...
        detailedDescription:
            "영업이익률이 12%로 양호한 수익성을 보이고 있습니다. 안정적인 영업 구조를 갖추고 있습니다.",
        interpretationPoints: [
            "영업이익률 10% 이상이면 우수",
            "영업이익률 상승은 경쟁력 강화",
            "업종 평균과 비교 필요",
    ...
    },
    {
        ...
        detailedDescription:
            "유동비율이 180%로 단기 부채 상환 능력이 우수합니다. 재무적 안정성이 높습니다.",
        interpretationPoints: [
            "유동비율 150% 이상이면 안정적",
    ...
    },
    {
        ...
        detailedDescription:
            "주당순이익(EPS)이 전년 대비 8% 성장하며 꾸준한 이익 성장세를 보이고 있습니다.",
        interpretationPoints: [
            "EPS 지속 성장이 중요",
            "EPS 성장률 높을수록 좋음",
            "일회성 요인 제외한 분석 필요",
